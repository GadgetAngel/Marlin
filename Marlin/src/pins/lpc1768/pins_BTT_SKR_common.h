...
//#define HAS_BTT_EXP_MOT 1
  ...
  #else
    #error "Having a LCD that uses both EXP1/EXP2 and an expansion motor module on EXP1/EXP2 is not possible."
  #endif
#endif
...
//#define MAX6675_HW_SPI    //-2
  ...
  //MAX31855 board configuration for Software SPI
    ...
    #define MAX6675_DO_PIN                    P0_01       //P1_15 is E1_STEP_PIN
