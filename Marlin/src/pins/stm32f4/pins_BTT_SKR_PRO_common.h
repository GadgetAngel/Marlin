...
//-------------------------------------------------THERMOCOUPLE SECTION----------------------------------------------------------
    ...
    //#define myMAX31855_SW  // uncomment myMAX31855_SW for Software SPI, comment out myMAX31855_SW for Hardware SPI
      ...
      #define THERMO_SCK_PIN            PF9             // SCK    
      #define THERMO_DO_PIN             PC9             // MISO   
      #define THERMO_CS1_PIN            TEMP_0_PIN      // CS1 for first thermocouple
      #define THERMO_CS2_PIN            TEMP_1_PIN      //CS2 for secound thermocouple
